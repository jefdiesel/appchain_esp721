      ...
      <nav className="border-b border-zinc-800 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/marketplace" className="px-4 py-2 text-sm hover:text-[#C3FF00] transition">
              Marketplace
            </Link>
            <Link href="/mint" className="px-4 py-2 text-sm text-[#C3FF00]">
              Mint
            </Link>
            <Link href="/register" className="px-4 py-2 text-sm hover:text-[#C3FF00] transition">
              Register Name
            </Link>
            <Link href="/upload" className="px-4 py-2 bg-[#C3FF00] text-black font-semibold rounded-lg hover:bg-[#d4ff4d] transition">
              Upload Site
            </Link>
          </div>
        </div>
